resource "oci_core_vcn" "oci_vcn_test_01" {
  ...
  display_name   = var.oci_vcn_test_01_display_name
  dns_label      = var.oci_vcn_test_01_dns_label
}

resource "oci_core_internet_gateway" "oci_igw_test_01" {
  compartment_id = var.oci_vcn_test_01_compartment_id
  vcn_id         = oci_core_vcn.oci_vcn_test_01.id
  display_name   = var.oci_igw_test_01_display_name
  enabled        = true
}
...
resource "oci_core_route_table" "oci_rt_test_01" {
  compartment_id = var.oci_vcn_test_01_compartment_id
  vcn_id         = oci_core_vcn.oci_vcn_test_01.id
  display_name   = var.oci_rt_test_01_display_name
...
resource "oci_core_subnet" "oci_subnet_test_01" {
  compartment_id             = var.oci_vcn_test_01_compartment_id
  vcn_id                     = oci_core_vcn.oci_vcn_test_01.id
  cidr_block                 = var.oci_subnet_test_01_cidr_block
  display_name               = var.oci_subnet_test_01_display_name
  dns_label                  = var.oci_subnet_test_01_dns_label
  availability_domain        = var.oci_subnet_test_01_availability_domain
